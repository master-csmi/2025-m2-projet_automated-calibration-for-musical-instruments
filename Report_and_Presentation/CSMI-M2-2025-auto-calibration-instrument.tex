...
\begin{equation}
\mathbf{\tilde{u}}_h = (\tilde{p_h}, \tilde{v_h})^T \in (V_h^k)^2,
\end{equation}
where
\begin{equation}
V_h^k =
...
\frac{1}{2}
\left(
\mathbf{F}(\mathbf{\tilde{u}}^-) + \mathbf{F}(\mathbf{\tilde{u}}^+)
\right)
-
\frac{\lambda_{j+\frac12}}{2}
\left(
\mathbf{\tilde{u}}^+ - \mathbf{\tilde{u}}^-
\right),
\label{eq:rusanov}
\end{equation}
...
\begin{aligned}
\int_{K_j}
\partial_t \tilde{p}_h \, \phi_p \, dx
&-
\int_{K_j} \tilde{v}_h \, \partial_x \phi_p \, dx \\
&+
...
\begin{aligned}
\int_{K_j}
\partial_t \tilde{v}_h \, \phi_v \, dx
&-
\int_{K_j} \tilde{p}_h \, \partial_x \phi_v \, dx \\
&+
