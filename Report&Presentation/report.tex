...
\begin{abstract}
Abstract (in English): present the objective, the main method and the key results in 3–6 lines.
\end{abstract}
...
A reed acts \cite{chaigne:hal-05370840} as a valve that controls the airflow driven by a pressure difference between the upstream region 
(the player’s mouth) and the downstream region (the mouthpiece or mouthpiece tip of the instrument). \newline
A reed may be modeled as a compliant structure, such as a beam, experiencing a pressure difference across its two sides.
