...
\begin{frame}[plain]
    ...
    \vfill
    \begin{center}
        \includegraphics[height=2.5cm]{inria_logo.png}\hspace{0.0em}%
        \includegraphics[height=2.5cm]{modartt_logo.png}\hspace{0.0em}%
        \includegraphics[height=1.6cm]{logo_irma.png}
    \end{center}
    \vspace{0.8em}
...
\begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
        \centering
        \vspace{-1ex}
        \includegraphics[width=\linewidth,keepaspectratio]{reed_column.png} 
        \par\smallskip
...
\begin{itemize}
    ...
    \end{equation}
    where $\mathbf{b}_k^n$ depends only on $u_k^n$ and numerical fluxes.
\end{itemize}
\end{frame}
...
\slideTitle{Result - Constant Cross-Section}
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.65\textwidth]{dg_solution_const_N800.png}
...
\begin{columns}[T]
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{dg_convergence_T0.5_euler.png}
    ...
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{dg_convergence_T0.5_rk2.png}
...
\begin{columns}[T]
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{dg_convergence_T0.8_euler.png}
    ...
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=0.7\linewidth]{dg_convergence_T0.8_rk2.png}
...
\begin{columns}[T]
    \begin{column}{0.5\textwidth}
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=\linewidth]{exp_profile.png}
    ...
    \begin{column}{0.5\textwidth}
        \begin{figure}[htbp]
            \centering
            \includegraphics[width=\linewidth]{cone_profile.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{dg_solution_exp_N800.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.65\textwidth]{dg_solution_cone_N800.png}
...
\begin{columns}[T]
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{performance_euler.png}
        \par\smallskip
        \scriptsize (a) Explicit Euler
    \end{column}
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{performance_rk2.png}
        \par\smallskip
