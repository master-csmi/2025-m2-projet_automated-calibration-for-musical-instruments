...
\begin{empheq}[left=\empheqlbrace]{align}
    ...
    \frac{S^\ast}{c S(x)}\,\partial_t v(x,t) + \partial_x p(x,t) &= 0
\end{empheq}
\end{subequations}
\end{minipage}
\begin{itemize}
...
\begin{itemize}
    ...
    c_2=c_1 b.
    \]
    \item Solve $\phi(t)$ (Euler explicit or RK2), then propagate $w^-_{\mathrm{ref}}$ along the characteristic.
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item Total right-going characteristic: $$w^-(x,t)= w^-_{pde}(x,t) + w^-_\mathrm{ref}(x,t)= w^-_0(x+ct) + w^-_\mathrm{ref}(x,t)$$.
    \item Left-going characteristic: $$w^+(x,t) = w^+_{pde}(x,t) =  w^+_0(x-ct)$$.
