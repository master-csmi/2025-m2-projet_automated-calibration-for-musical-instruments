...
\begin{columns}[T]
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/dg_convergence.png}
        \scriptsize DG convergence.
        \label{fig:dg_convergence}
    \end{column}
    \begin{column}{0.5\textwidth}
        \centering
        \includegraphics[width=\linewidth]{Images/dg_duration.png}
        \scriptsize DG solution.
        \label{fig:dg_duration}
    \end{column}
\end{columns}
\end{frame}
