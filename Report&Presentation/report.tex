...
In JAX framework:
\begin{enumerate}
    \item Implement a discontinous Galerkin discretization of the mixt form of the wave equation and numerically solve it.
...
Let's see the result of the Discontinuous Galerkin Method implementation : 

\begin{figure}[htbp]
    \centering
    % Remplacez 'figs/dg_solution.png' par le chemin et l'extension réels de votre image (pdf, png, jpg...)
    \includegraphics[width=0.9\textwidth]{Images/dg_solution.png}
    \caption{DG numerical solutions for pressure and acoustic volume velocity.}
    \label{fig:dg_solution}
\end{figure}

As shown in Figure \ref{fig:dg_solution}, the numerical solution obtained using the Discontinuous Galerkin Method accurately captures 
...
The convergence of the DG method was verified by comparing the numerical solution to the analytical solution at various time steps with an Explicit Euler
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/dg_convergence_euler.png}
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Images/dg_convergence_rk2.png}
        \caption{Convergence of the DG method with Rk2 scheme.}
        \label{fig:convergence_plot_rk2}
    \end{minipage}
\end{figure}

The convergences verify the theoritical rates of convergence for the DG method with polynomial degree $d$ : order $d$ for the Explicit Euler scheme and order $2d$ for the Runge-Kutta 2nd order scheme.
